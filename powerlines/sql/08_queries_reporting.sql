...
-- Индекс по region_id должен уменьшить стоимость выборки ВЛ региона.
-- Каждая комманда ниже выполняется вручную, для удобства проверки результатов.
-- Подход с остальными индексами аналогичен: удалили индекс или индексы, проверили план выполнения, восстанали индекс или индексы, проверили план выполнения.
